...
import { Copy, Facebook, Github, Instagram, Mail, Phone } from "lucide-react";
...
export function ContactDock() {
  ...
  const dockItems: Array<{
  ...
  }> = [
    {
      ...
      ariaLabel: "Send email to danny.otgontsetseg@gmai.com",
      showEmail: true,
      email: "danny.otgontsetseg@gmai.com",
      onCopy: () =>
        copyToClipboard("danny.otgontsetseg@gmai.com", "email address"),
    },
    {
      icon: Phone,
      label: "Phone",
